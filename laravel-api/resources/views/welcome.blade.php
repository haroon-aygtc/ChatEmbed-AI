...
<head>
    ...
    <title>ChatEmbed AI - Laravel API</title>
...
<body>
    ...
    <header class="header">
        <div class="container">
            <div class="header-content">
                <a href="/" class="logo">ChatEmbed AI</a>
                <nav class="nav">
    ...
    <main class="container" style="padding-top: 3rem;">
        ...
        <section class="text-center mb-5">
            <h1
                style="font-size: 3rem; font-weight: 700; color: var(--sage-800); margin-bottom: 1rem; line-height: 1.2;">
                Laravel 12 API Backend
            </h1>
            <p style="font-size: 1.25rem; color: var(--text-muted); max-width: 600px; margin: 0 auto 2rem;">
                Beautiful, natural-themed API backend for ChatEmbed AI. Built with Laravel 12 and designed with
        ...
        <section id="status" class="mb-5">
            <h2
                style="font-size: 2rem; font-weight: 600; color: var(--sage-700); margin-bottom: 2rem; text-align: center;">
                System Status
            </h2>
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
                <div class="card fade-in">
                    <div class="card-header">
                        <h3 class="card-title">🌿 Laravel Framework</h3>
                        <p class="card-description">Core framework status</p>
                    </div>
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <span style="color: var(--text-secondary);">Version {{ app()->version() }}</span>
                ...
                <div class="card fade-in" style="animation-delay: 0.1s;">
                    <div class="card-header">
                        ...
                        <p class="card-description">Database connectivity status</p>
                    </div>
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <span style="color: var(--text-secondary);">{{ config('database.default') }}</span>
                ...
                <div class="card fade-in" style="animation-delay: 0.2s;">
                    <div class="card-header">
                        ...
                        <p class="card-description">Current environment mode</p>
                    </div>
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <span style="color: var(--text-secondary);">{{ app()->environment() }}</span>
                        <span class="badge badge-info">{{ ucfirst(app()->environment()) }}</span>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem;">
                <div class="card slide-up">
                    <div class="card-header">
                        ...
                        <p class="card-description">Manage conversations and messages</p>
                    </div>
                    <ul style="list-style: none; padding: 0; color: var(--text-secondary);">
                        <li style="margin-bottom: 0.5rem;">✓ Create conversations</li>
                        <li style="margin-bottom: 0.5rem;">✓ Send/receive messages</li>
                        <li style="margin-bottom: 0.5rem;">✓ Real-time updates</li>
                        <li style="margin-bottom: 0.5rem;">✓ Message history</li>
                    </ul>
                </div>

                <div class="card slide-up" style="animation-delay: 0.1s;">
                    <div class="card-header">
                        <h3 class="card-title">🎨 Widget Customization</h3>
                        <p class="card-description">Customize chat widget appearance</p>
                    </div>
                    <ul style="list-style: none; padding: 0; color: var(--text-secondary);">
                        <li style="margin-bottom: 0.5rem;">✓ Theme customization</li>
                        <li style="margin-bottom: 0.5rem;">✓ Color schemes</li>
                        <li style="margin-bottom: 0.5rem;">✓ Layout options</li>
                        <li style="margin-bottom: 0.5rem;">✓ Branding settings</li>
                    </ul>
                </div>
                ...
                <div class="card slide-up" style="animation-delay: 0.2s;">
                    <div class="card-header">
                        ...
                        <p class="card-description">Track performance and usage</p>
                    </div>
                    <ul style="list-style: none; padding: 0; color: var(--text-secondary);">
                        <li style="margin-bottom: 0.5rem;">✓ Conversation metrics</li>
                        <li style="margin-bottom: 0.5rem;">✓ User engagement</li>
                        <li style="margin-bottom: 0.5rem;">✓ Response times</li>
                        <li style="margin-bottom: 0.5rem;">✓ Custom reports</li>
                    </ul>
                </div>
